...
public class GameManager2 : MonoBehaviour
{
    ...
    private void CharacterUpdate()
    {
        ...
        {
            var currentScenePlayers = PhotonManager.Instance.client.CurrentRoom.Players.Where(kvp => (int)kvp.Value.CustomProperties["PlayerScene"] == roomNumber).ToDictionary(kvp => kvp.Key, kvp => kvp.Value);
